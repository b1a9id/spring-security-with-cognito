...
public class CognitoService {
	...
	private Optional<AdminInitiateAuthResult> adminInitiateAuthResult(AdminInitiateAuthRequest request) {
		try {
			...
			throw new com.example.springsecuritywithcognito.exception.UserNotFoundException("username " + username + " not found.", e);
		}
	}
	...
	public Optional<AdminRespondToAuthChallengeResult> adminRespondToAuthChallenge(
		...
		try {
			...
			throw new com.example.springsecuritywithcognito.exception.UserNotFoundException("user not found.", e);
		} catch (com.amazonaws.services.cognitoidp.model.InvalidPasswordException e) {
			throw new com.example.springsecuritywithcognito.exception.InvalidPasswordException("invalid password.", e);
		}
	}
}
